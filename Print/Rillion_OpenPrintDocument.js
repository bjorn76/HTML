function OpenPrintDocument() {
                    window.open('./DocumentHandlers/PurchaseOrderHtml.ashx?action=print', '', 'scrollbars=yes,menubar=no,height=400,width=400,resizable=yes,toolbar=no,location=no,status=no');
                    __doPostBack('__Page', 'print')
                }
                var __cultureInfo = {
                    "name": "sv-SE",
                    "numberFormat": {
