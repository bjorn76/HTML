/**
 * Dynamisk ViVa Vind Data Shortcode med Auto-Refresh - Version 15
 * Centraliserad version med omstrukturerad presentation och tidsstämpel.
 * Usage: [vivavind_v15 id="220"]
 */
...
if ( ! class_exists( 'Viva_Wind_Widget_V15' ) ) {

    class Viva_Wind_Widget_V15 {

        // =========================================================================
        // CENTRALISERAD KONFIGURATION - ÄNDRA ENDAST HÄR VID NY VERSION
        // =========================================================================
        const VERSION     = '15';
        const SHORTCODE   = 'vivavind_v15'; 
        const CACHE_TTL   = 90; // Tid i sekunder som datan cachas
        const REFRESH_MS  = 120000; // Tid i millisekunder för auto-refresh (2 min)
        ...
        /**
         * Datatvätt och omstrukturering. Sparar nu även 'updated'.
         */
        private static function format_data( $api_data ) {
            ...
            foreach ( $samples as $sample ) {
                ...
                // Spara tidsstämpeln från Sjöfartsverket
         ...
         * NY LAYOUT: Byvind överst, Medelvind i mitten, Riktning under, Uppdaterad tid längst ner.
         */
        ...
        /**
         * Kortkods-hanterare [vivavind_v15 id="..."]
         */
