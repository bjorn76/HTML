/**
 * Dynamisk ViVa Vind Data Shortcode - Version 34
 * Fix: Automatisk skalning av stationsnamn (Auto-fit).
 * Usage: [vivavind_v34 id="220"]
 */
...
if ( ! class_exists( 'Viva_Wind_Widget_V34' ) ) {

    class Viva_Wind_Widget_V34 {

        const VERSION     = '34';
        const SHORTCODE   = 'vivavind_v34'; 
        const CACHE_TTL   = 90; 
