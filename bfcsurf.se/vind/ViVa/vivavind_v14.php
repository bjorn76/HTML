/**
 * Dynamisk ViVa Vind Data Shortcode med Auto-Refresh - Version 14
 * Centraliserad versionshantering för maximal underhållsbarhet.
 */
...
if ( ! class_exists( 'Viva_Wind_Widget_V14' ) ) {

    class Viva_Wind_Widget_V14 {

        // =========================================================================
        // CENTRALISERAD KONFIGURATION - ÄNDRA ENDAST HÄR VID NY VERSION
        // =========================================================================
        const VERSION     = '14';
        const SHORTCODE   = 'vivavind_v14'; 
        ...
        /**
         * Hämtar rådata från Sjöfartsverkets API (med centraliserad cache-nyckel).
         */
        ...
        /**
         * Kortkods-hanterare [vivavind_v14 id="..."]
         */
