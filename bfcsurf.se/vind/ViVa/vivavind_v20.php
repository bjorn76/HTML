/**
 * Dynamisk ViVa Vind Data Shortcode med Auto-Refresh - Version 20
 * Inkluderar inbyggd Flexbox-wrapper för horisontell placering av korten.
 * Usage: 
 * [vivavind_wrapper_v20]
 * [vivavind_v20 id="220"]
 * [vivavind_v20 id="88"]
 * [/vivavind_wrapper_v20]
 */
...
if ( ! class_exists( 'Viva_Wind_Widget_V20' ) ) {

    class Viva_Wind_Widget_V20 {

        // =========================================================================
        // CENTRALISERAD KONFIGURATION - ÄNDRA ENDAST HÄR VID NY VERSION
        // =========================================================================
        const VERSION           = '20';
        const SHORTCODE         = 'vivavind_v20'; 
        const WRAPPER_SHORTCODE = 'vivavind_wrapper_v20'; // Inbyggd flexbox-wrapper
        const CACHE_TTL         = 90; 
        ...
        /**
         * Initierar mätstations-shortcode, wrapper-shortcode och AJAX-hookar.
         */
        ...
        /**
         * Hanterar den omslutande Flexbox-containern [vivavind_wrapper_v20]...[/vivavind_wrapper_v20]
         */
        public static function render_wrapper_shortcode( $atts, $content = null ) {
            return '<div style="display: flex; flex-direction: row; gap: 10px; flex-wrap: wrap;">' . do_shortcode( $content ) . '</div>';
        }
        ...
        /**
         * HTML-presentation med renodlade CSS-klasser.
         */
        ...
        /**
         * Kortkods-hanterare [vivavind_v20 id="..."]
         */
