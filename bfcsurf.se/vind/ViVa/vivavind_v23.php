/**
 * Dynamisk ViVa Vind Data Shortcode med Auto-Refresh - Version 23
 * 40% större stationsnamn, samt aggressiv rensning av wpautop-skräp
 * för 100% perfekta mellanrum mellan kvadraterna.
 * Usage: 
 * [vivavind_wrapper_v23]
 * [vivavind_v23 id="220"]
 * [vivavind_v23 id="88"]
 * [/vivavind_wrapper_v23]
 */
...
if ( ! class_exists( 'Viva_Wind_Widget_V23' ) ) {

    class Viva_Wind_Widget_V23 {

        const VERSION           = '23';
        const SHORTCODE         = 'vivavind_v23'; 
        const WRAPPER_SHORTCODE = 'vivavind_wrapper_v23'; 
        const CACHE_TTL         = 90; 
        ...
        /**
         * Flexbox-wrappern: Tvättar aggressivt bort WordPress "wpautop"-skräp.
         */
        public static function render_wrapper_shortcode( $atts, $content = null ) {
            // Kör shortcodes inuti
            $parsed_content = do_shortcode( $content );
            
            // Ta bort alla p och br-taggar som WordPress skjuter in mellan shortcodes
            $clean_content = str_replace( array('<p>', '</p>', '<br>', '<br />', '<br/>'), '', $parsed_content );
            
            // Ta bort dolda mellanslag/radbrytningar mellan html-taggar så flexboxen blir perfekt
        ...
        public static function render_shortcode( $atts ) {
            ...
            if ( ! defined( "VIVA_WIND_CSS_RENDERED_V{$v}" ) ) {
                ...
                ?>
                <style type="text/css">
                    /* Flexbox wrappern med ren design */
                    .viva-flexbox-v<?php echo $v; ?> {
                        display: flex !important;
                        flex-direction: row !important;
                        flex-wrap: wrap !important;
                        gap: 15px !important; /* Exakt 15px symmetriskt mellanrum överallt */
                    ...
                    /* Göm undan skräp om str_replace inte biter på allt från teman */
                    .viva-flexbox-v<?php echo $v; ?> > p,
                    .viva-flexbox-v<?php echo $v; ?> > br {
                        display: none !important;
                    }

                    /* AJAX-behållaren. Denna MÅSTE vara ren utan margins */
                    .<?php echo $wrapper_cl; ?> {
                    ...
                    .viva-card-v<?php echo $v; ?> {
                        ...
                        margin: 0 !important; /* Nollställd för att låta Flexbox-gap styra avstånden perfekt */
                    ...
                    /* H4 = Stationsnamnet. Här är storleken ökad med 40% (16px -> 22px) */
